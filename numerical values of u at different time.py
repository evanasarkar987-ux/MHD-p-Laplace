...
def solve_problem():
    ...
    problem = NonlinearProblem(
        ...
        w,
        bcs=[bc_B, bc_u, bc_p],
        petsc_options_prefix="plot_u_direction_",
        petsc_options={
            "snes_type": "newtonls",
...
for i in range(grid_n):
    for j in range(grid_n):
        ...
        u_value = evaluate_function_at_point(uh, point, domain)
...
plt.savefig("u_direction_plot_t_1_0.png", dpi=200)

print("Saved plot to u_direction_plot_t_1_0.png")
